...
public class LocalAnvilScreenHandler extends AnvilScreenHandler {
    protected final Set<Item> set;

    public LocalAnvilScreenHandler(int syncId, PlayerInventory inventory, ScreenHandlerContext context, Item... items) {
